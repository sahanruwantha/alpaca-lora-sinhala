...
sinhala_to_english = {
    ...
    'ග': 'ga', 'ග්': 'g', 'ගා': 'gaa', 'ගැ': 'gA', 'කෑ': 'gAa','කි': 'gi', 'කී': 'gii', 'කු': 'gu', 'කූ': 'guu', 'කෘ': 'gru', 'කෲ': 'gruu', 'කෙ': 'ge','කේ': 'gee', 'කෛ': 'gai', 'කො': 'go', 'කෝ': 'goo', 'කෞ': 'gau', 'කඃ': 'gaH', 'කං': 'gax','කඞ': 'gaX', 'ක්‍ය': 'gya', 'ක්‍ර': 'gra',
    ...
    'ඡ': 'chha', 'ක්': 'ch', 'කා': 'chaa', 'කැ': 'chA', 'කෑ': 'chAa','කි': 'chi', 'කී': 'chii', 'කු': 'chu', 'කූ': 'chuu', 'කෘ': 'chru', 'කෲ': 'chruu', 'කෙ': 'che','කේ': 'chee', 'කෛ': 'chai', 'කො': 'cho', 'කෝ': 'choo', 'කෞ': 'chau', 'කඃ': 'chaH', 'කං': 'chax','කඞ': 'chaX', 'ක්‍ය': 'chya', 'ක්‍ර': 'chra',
